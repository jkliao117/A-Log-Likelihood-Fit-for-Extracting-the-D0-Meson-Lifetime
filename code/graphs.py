...
plt.plot(t_0,f_t1,'Blue')
plt.plot(t_0,f_t2,'LightSeaGreen' )
plt.plot(t_0,f_t3,'Navy')
plt.legend(['average','half average', 'double average'])
plt.xlim([-2,4])
plt.xlabel('decay time (ps)')
plt.ylabel('probability density')
plt.title('true decay function vs decay time for different errors')
...
plt.plot(t_0,f_t4,'Red')
plt.plot(t_0,f_t5,'Salmon' )
plt.plot(t_0,f_t6,'Maroon')
plt.legend(['average','half average', 'double average'])
plt.xlim([-2,4])
plt.xlabel('decay time (ps)')
plt.ylabel('probability density')
plt.title('true decay function vs decay time for different lifetimes')
